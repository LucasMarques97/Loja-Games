...
ProdutoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([produto_entity_1.Produto]), database_module_1.DatabaseModule],
        providers: [produto_service_1.ProdutosService],
        controllers: [produto_controller_1.ProdutosController],
